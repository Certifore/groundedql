...
Usage (programmatic):
    from groundedql.spec_builder import build_spec, write_spec
...
def build_spec(schema_path: str | Path) -> Dict[str, Any]:
    ...
    spec["version"] = 1
    spec["name"] = "GroundedQL QueryPlan Spec (auto-generated)"
    spec["description"] = (
        "Auto-generated from schema.yaml. "
        "Instructions for generating QueryPlan JSON for the GroundedQL compiler. "
